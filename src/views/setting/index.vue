<template>
  <div class="settings-container">
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="15">
          <el-form ref="form" :model="user" label-width="70px" :rules="rules">
        ...
        <el-col :offset="2" :span="4">
          <label for="file">
            <el-avatar class="preview" shape="square" :size="150"
                fit="cover" :src="user.photo"/>
            <p class="edit">点击修改头像</p>
          </label>
    ...
    <el-dialog title="修改头像" :visible.sync="dialogVisible"
        append-to-body @opened="onDialogOpened" width="30%">
...
<script>
import { getUserProfile, updateImage, updateUserProfile } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    onDialogOpened () {
      ...
      // 初始化裁切器
      if (this.cropper) {
        this.cropper.replace(this.previewImage)//更新图片网址
        return
      }
